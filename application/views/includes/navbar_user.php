  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <div class="sidebar">
      ...
      <!-- <div class="user-panel mt-3 pb-3 mb-3 d-flex">
        <div class="image">
          <img src="<\?php echo base_url(); ?>/assets/dist/img/user2-160x160.jpg" class="img-circle elevation-2" alt="User Image">a
        </div>
        <div class="info">
          <label for="Name" class="d-block" style="text-transform:uppercase;color:white;"><?php echo $this->session->userdata('name'); ?></label>
        </div>
      </div> -->
        ...
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item menu-open">
            ...
            <ul class="nav nav-treeview">
              ...
              <li class="nav-item">
                <a href="<?php echo base_url('home/goToFiles/'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>File Manager</p>
                </a>
              </li>
              <li class="nav-item">
                <a href="<?php echo base_url('home/goToProfile/'); ?>" class="nav-link">
                  <i class="far fa-circle nav-icon"></i>
                  <p>My Profile</p>
                </a>
              </li>
